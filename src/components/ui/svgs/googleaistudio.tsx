...
export function GoogleAIStudio(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            fill="none"
            ...
            {...props}
        >
            <g clipPath="url(#googleai-clip)" fillRule="evenodd" clipRule="evenodd" fill="#000">
